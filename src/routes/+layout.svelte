<script lang="ts">
	...
	$: navContainerClasses = 'max-w-6xl mx-auto px-8 flex items-center justify-between h-25';
	...
	$: mobileNavClasses = 'md:hidden fixed top-25 left-0 right-0 bg-white border-b border-light-gray shadow-lg z-[100] transform -translate-y-full transition-transform duration-300 ease-out';
	...
	$: mobileNavContainerClasses = 'max-w-6xl mx-auto md:px-8 px-4 flex items-center justify-between h-25';
