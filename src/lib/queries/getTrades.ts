import { BASE_ORDERBOOK_SUBGRAPH_URL, BASE_SFT_SUBGRAPH_URL, ENERGY_FEILDS } from "$lib/network";

export const getTradesForClaims = async (orderHash: string, ownerAddress: string, feildName: string): Promise<any> => {
