<script lang="ts">
	...
	$: indicatorClasses = 'w-2 h-2 bg-black/30 rounded-full cursor-pointer transition-colors duration-200 hover:bg-black/50 touch-target';
	$: indicatorActiveClasses = 'w-2 h-2 bg-primary rounded-full cursor-pointer transition-colors duration-200 touch-target';
